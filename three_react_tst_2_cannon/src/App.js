...
{/*
        ...
        <ModelTst2 modelId={"Projects"} position={[5, 5, -1.5]} mass={100} />
        <ModelTst2 modelId={"Skills"} position={[5, 7, 0]} mass={100} />
        <ModelTst2 modelId={"Contact"} position={[5, 10, -2]} mass={100} />
      </Physics>
      {/* <Physics> */}
        {/* <Plane /> */}
      {/* </Physics> */}
