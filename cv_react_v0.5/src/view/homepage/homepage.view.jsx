...
import './homepage.view.style.scss'
...
class Homepage extends Component {
    ...
    push_to_history(route){
        return ()=>{on_mouse_leave(); this.props.history.push(route)}
    }
            ...
            <>
                ...
                >
                    ...
                    <Physics step={1/40} iterations={2} allowSleep={false} >
                        ...
                        <ModelBB
                            src={'./models/tinModelsTst2.glb'}
                            modelId={"Projects"} position={[3, 60, -7]} mass={100}  rotation={[0,-0.6,0]}  scale={[2,1.5,1.5]}
                            pmaterial={{friction:1000,restitution:0.01}}
                            onClickF={this.push_to_history("/projects")}
                            onPointerEnterF={on_mouse_enter}
                            onPointerLeaveF={on_mouse_leave}
                        />
...
function log_mesh_click(e){ console.log(e); }
function on_mouse_enter(e){ console.log(e); document.body.style.cursor = "pointer" }
function on_mouse_leave(e){ console.log(e); document.body.style.cursor = "default" }
